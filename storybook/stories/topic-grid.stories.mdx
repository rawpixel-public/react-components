...
<Preview>
  <Story name="topic">
    <Centered style={{background: "#FFF"}}>
      <Topic id={text("id", 1, "topic")} icon={text("icon", starSvg, "topic")} name={text("name", "My topics", "topic")} isLoading={boolean("isLoading", false, "topic")} isTagged={boolean("isTagged", false, "topic")} isTagMode={boolean("isTagMode", false, "topic")} onTopicClick={action("topic-click")} active={boolean("active", false, "topic")} />
    </Centered>
  </Story>
</Preview>
...
<Preview>
  <Story name="link">
    <Centered style={{background: "#FFF"}}>
      <Topic to={text("to", "/my-topics", "link")} id={text("id", 1, "link")} icon={text("icon", starSvg, "link")} name={text("name", "My topics", "link")} isLoading={boolean("isLoading", false, "link")} isTagged={boolean("isTagged", false, "link")} isTagMode={boolean("isTagMode", false, "link")}  active={boolean("active", false, "link")} />
    </Centered>
  </Story>
</Preview>
